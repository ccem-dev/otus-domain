angular.module('Login', ['ngMaterial', 'ngMessages', 'ui.mask']).controller('LoginController', function($scope, $http, $window) {
    ...
    var HTTP_URL_LOGIN_SUCCESS = window.location.origin + '/otus-domain/private/index.html';
    var HTTP_URL_REGISTER_PAGE = window.location.origin + '/otus-domain/public/user/register/user/register-user.html';
    var HTTP_URL_CONFIG_PAGE = window.location.origin + '/otus-domain/public/setting/register-adm.html';
    var HTTP_URL_HOME_PAGE = window.location.origin + '/otus-domain/private/index.html';
