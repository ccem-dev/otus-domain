        ...
        $stateProvider
            ...
            .state({
                ...
                resolve: {
                    ...
                    initialize: function (ActivityConfigurationRestService, SurveyGroupRestService, StageRestService) {
            ...
            .state({
                ...
                resolve: {
                    ...
                    initialize: function (StageRestService) {
                       StageRestService.initialize();
                    }
                },
                views: {
                    ...
                    'system-content@stage': {
                        template: '<stage-configuration flex></stage-configuration>'
                    }
                }
            })
            .state('offline', {
